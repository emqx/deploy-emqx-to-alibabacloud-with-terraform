...
# && sudo apt-get update && sudo apt-get install -y haproxy=2.2.\*
# sudo systemctl stop haproxy.service
# sudo systemctl disable haproxy.service
# sudo cp -r /opt/tmp/emqx_basic/haproxy/certs/ /opt/
# sudo cp /opt/tmp/emqx_basic/haproxy/haproxy.cfg /etc/haproxy/haproxy.cfg
